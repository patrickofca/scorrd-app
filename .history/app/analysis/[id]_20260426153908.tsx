        ...
        {scoreInfoOpen && (
          <View style={styles.scoreInfoPanel}>
            ...
            <Text style={[styles.scoreInfoText, { marginTop: 10 }]}>
              ...
              content online—that's genuinely elite, rarely accomplished and
              happen usally by chance.
            </Text>
            <Text style={styles.bulletTitle}>• Troubleshoot low scores:</Text>
            <Text style={styles.bodyText}>
              If your post is still scoring lower than you’d like after
              generation, check the{" "}
              <Text style={styles.linkText}>improvements list</Text> in the
              documentation below. Tweak a few specific elements and run it
              through the analyzer again.
            </Text>
            <Text style={[styles.scoreInfoText, { marginTop: 10 }]}>
