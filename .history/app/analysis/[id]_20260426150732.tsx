  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top"]}>
      ...
      >
        ...
        {scoreInfoOpen && (
          <View style={styles.scoreInfoPanel}>
            <Text style={styles.scoreInfoText}>
              A perfect 10 would require every scoring dimension to peak at the same time — but they naturally pull against each other. A post built for virality (emotional hooks, broad appeal) tends to dilute the specific call-to-action that drives lead capture. A post laser-focused on trust and authority often feels too polished to go viral.
            </Text>
            <Text style={[styles.scoreInfoText, { marginTop: 10 }]}>
              Scores above 9.5 are extremely rare and usually happen once in hundreds of posts. If you're hitting 8.5 or higher, you're in the top tier of real estate content online — that's genuinely elite.
            </Text>
            <Text style={[styles.scoreInfoText, { marginTop: 10 }]}>
              Use your score as a directional signal, not a perfection target. Consistent 8s beat occasional 10s every time.
            </Text>
          </View>
        )}
        ...
        {analysis.audienceMatchScore != null && analysis.audienceMatchVerdict && analysis.audienceMatchBreakdown && (
          <AudienceMatchCard
        ...
        {analysis.platformFit && analysis.platformFit.length > 0 && (
          <View style={styles.section}>
            ...
            <Text style={styles.sectionSub}>Tap a card to see exactly what to change</Text>
