...
export default function GenerateScreen() {
  ...
  const [photoRecommendations, setPhotoRecommendations] = useState<
    { platform: string; recommendation: string | null }[]
  >([]);
  ...
  async function handleGenerate() {
    ...
    try {
      ...
      setPhotoRecommendations(res.photo_recommendations ?? []);
  ...
  async function handleGetScore(post: GeneratedPost) {
    ...
    try {
      const result = await api.analyses.submit({
        ...
        ...(post.listingPriceRange
          ? { listing_price_range: post.listingPriceRange }
          : {}),
        ...(post.targetBuyerType?.length > 0
          ? { target_buyer_type: post.targetBuyerType }
          : {}),
    ...
    <SafeAreaView style={styles.safe} edges={["top"]}>
      ...
      >
            ...
            <View style={styles.photoMeta}>
              ...
              {photoScoreResult && (
                <>
                  ...
                  <Text style={styles.photoFix}>{photoScoreResult.fix}</Text>
                </>
              )}
              <TouchableOpacity
        ...
        <View style={styles.targetingTitleRow}>
          ...
          <Text style={[styles.targetingOptional, { marginTop: -1 }]}>
              ...
              <View style={styles.copyBox}>
                ...
                <View style={styles.copyActions}>
                  ...
                  <TouchableOpacity
                    style={[
                      styles.actionButton,
                      activePost.saved && styles.actionButtonSaved,
                    ]}
                  ...
                  >
                    {savingId === activePost.id ? (
                      ...
                      <>
                        <Ionicons
                          name={
                            activePost.saved ? "bookmark" : "bookmark-outline"
                          }
                          size={15}
                        ...
                        <Text
                          style={[
                            ...
                            activePost.saved && styles.savedText,
                          ]}
                        >
                ...
                <TouchableOpacity
                  style={[
                    styles.scoreButton,
                    scoringId === activePost.id && styles.scoreButtonDisabled,
                  ]}
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    Haptics.selectionAsync();
                    setScoreInfoOpen((o) => !o);
                  }}
                  activeOpacity={0.7}
                >
                  <Text style={styles.scoreInfoLabel}>
                    What does Get Score do?
                  </Text>
                  <Ionicons
                ...
                {scoreInfoOpen && (
                  <Text style={styles.scoreInfoBody}>
                    Scores this post across virality, lead capture, follower
                    attraction, and trust — then returns a composite score,
                    platform rewrites, hashtag strategy, and your top fixes.
                  </Text>
                )}

                {(() => {
                  const rec = photoRecommendations.find(
                    (r) => r.platform === activePost.platform,
                  );
                  return rec?.recommendation ? (
                    <View style={styles.photoGuidanceWrap}>
                      <InfoCallout
