...
const PLATFORM_OPTIMAL_TIMES: Record<string, string[]> = {
  instagram: ["Tue 11 AM", "Wed 10 AM", "Fri 10–11 AM"],
  facebook: ["Tue–Thu 8–9 AM", "Fri 1–4 PM"],
  linkedin: ["Tue–Thu 8–10 AM", "Thu 1–2 PM"],
  twitter: ["Mon–Fri 8–10 AM", "Wed 9 AM"],
  tiktok: ["Tue 9 AM", "Thu 12 PM", "Fri 5 AM"],
};
...
> = {
  instagram: {
    times: ["Mon 6–9 AM", "Tue 11 AM", "Fri 10–11 AM"],
    frequency: "3–5 Reels/week",
    cadence: "Every 1–2 days for consistent reach",
  },
  facebook: {
    times: ["Tue–Thu 8–9 AM", "Sat 9–11 AM"],
    frequency: "3–4 Reels/week",
    cadence: "Every 2 days — quality over quantity",
  },
  tiktok: {
    times: ["Tue 9 AM", "Thu 12 PM", "Fri 5–9 PM"],
    frequency: "1–4 Reels/day",
    cadence: "Daily posting drives fastest growth on TikTok",
  },
};
...
const PLATFORM_PHOTO_TIPS: Record<string, { tips: string[]; avoid: string[] }> =
  {
    instagram: {
      tips: [
        "Shoot vertical (4:5) so your photo takes up more space in the feed",
        "Use natural light — position the room so light is coming in from the side",
        "Lead with your best room: primary bedroom, living room, or a great view",
        "Take exterior photos around sunset — the warm light makes everything look better",
      ],
      avoid: [
    ...
    facebook: {
      tips: [
        "Add simple staging like a plant or coffee setup — helps buyers picture living there",
        "Include neighborhood shots to show what it’s like to live there",
        "Slightly warm, natural-looking photos tend to get more engagement",
    ...
    linkedin: {
      tips: [
        "Use a straight-on exterior shot — clean and professional",
        "Stick with natural daylight — no flash",
        "Include a person when it makes sense — people connect with faces",
        "Keep things simple and tidy — less is more here",
      ],
      avoid: [
