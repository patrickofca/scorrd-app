...
import { Stack, useRouter, useSegments, usePathname, useGlobalSearchParams, SplashScreen } from 'expo-router';
...
function NotificationBanner() {
  ...
  useEffect(() => {
    const sub = Notifications.addNotificationReceivedListener((notification) => {
      ...
      setBody(notification.request.content.body ?? 'A new lead was captured.');
      setVisible(true);
  ...
  return (
    ...
    >
      ...
      <View style={styles.bannerText}>
        ...
        <Text style={styles.bannerBody} numberOfLines={1}>{body}</Text>
      </View>
    </Animated.View>
  );
}
