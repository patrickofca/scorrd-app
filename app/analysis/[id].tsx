...
export default function AnalysisResultScreen() {
  ...
  useEffect(() => {
    if (error instanceof AuthExpiredError) {
      useFormDraftStore.getState().saveReturnPath(`/analysis/${id}`);
  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top"]}>
      ...
      >
        ...
        {scoreInfoOpen && (
          <View style={styles.scoreInfoPanel}>
            ...
            <Text style={[styles.scoreInfoText, { marginTop: 10 }]}>
              ...
              <Text style={{ fontWeight: "bold" }}>2 and 4</Text>. Moving your
              content into the{" "}
              <Text style={{ fontWeight: "bold" }}>7+ range</Text> represents a
              massive improvement over other agents' posts.
            </Text>

            <Text style={[styles.scoreInfoText, { marginTop: 10 }]}>
              In our system, any score of 7 or higher is considered fully
              optimized and ready for prime time. Scores above 9.5 are extremely
              rare and usually happen once in hundreds of posts. If you're
              hitting 8.5 or higher, you're in the top tier of real estate
              content online—that's genuinely elite.
            </Text>

            <Text style={[styles.bulletTitle, { marginTop: 10 }]}>
              • Troubleshoot low scores:
            </Text>
            <Text style={styles.scoreInfoText}>
              If your post is still scoring lower than you’d like after
              generation, check the improvements listed in the documentation
              below. Tweak a one or two specific elements and run it through the
              analyzer again.
            </Text>

            <Text style={[styles.scoreInfoText, { marginTop: 10 }]}>
              Use your score as a directional signal, not a perfection target. A
              perfect 10 is not the goal; anything{" "}
              <Text style={{ fontWeight: "bold" }}>7+</Text> is acceptable and
              optimized. Consistent 8's beat occasional 10's every time.
            </Text>
          </View>
        )}
        ...
        {/* Mismatch warning — only when score is below 5.0 */}
